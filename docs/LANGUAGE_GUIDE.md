...
Use these phrases consistently when they apply:

- "Partner" / "Partnership": emphasizes collaborative relationship.
- "Highest quality" / "Freshest flowers": quality promise (avoid "best").
- "Competitive wholesale pricing": price positioning for trade customers.
- "Sustainable sourcing": values & sourcing claim.
- "Reliable / Timely delivery": logistics & trust.
- "Design partner" / "professional-grade": for Inspirations and design resources.

## Structural rules (how to compose copy)

- Lead with the user's benefit. Start with the primary professional value (e.g., quality, reliability, pricing).
- Be concise. Use short paragraphs and clear headers. B2B readers scan copy quickly.
...
- CTA language
  - Do: "Browse catalog" / "Explore boxlots" / "Start shopping"
  - Don't: "Shop now!" (too consumer-oriented and generic)
...
- Write helpful, descriptive alt text and page titles that include trade-oriented terms where relevant ("bulk boxlots for florists" vs "bulk flowers").
- Keep headings semantic and sequential (H1 once per page, H2 for major sections).
- Use short sentences where possible; this helps readability and screen readers.

## Words & phrases to avoid

- Avoid generic superlatives without context: "best", "ultimate".
- Avoid B2C phrases: "perfect gift", "for everyone", "daily deals".
- Avoid vague claims: instead of "unique", say what makes it different (e.g., "seasonally curated from local growers").

## Quick checklist for editors

Before publishing, verify:
- Does this speak to trade customers (florists / retailers / event pros)?
- Does it use partnership language when appropriate?
- Are claims specific & verifiable (quality, sourcing, pricing, delivery)?
- Is the copy concise and scannable for busy professionals?
