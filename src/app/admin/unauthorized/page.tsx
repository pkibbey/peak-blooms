        ...
        {isSignedIn ? (
          <>
            <p className="text-sm text-muted-foreground">
              ...
              but your account does not have admin access. If this is an error, please contact the
              site administrator to request access.
            </p>

            <div className="grid gap-3">
              <Button asChild variant="outline" className="w-full">
                <a href="mailto:hello@peakblooms.com?subject=Admin%20Access%20Request">Request Admin Access</a>
              </Button>
