...
export default function UsersTable({ users, sort, order }: UsersTableProps) {
  ...
  const handleMultiplierSave = async (userId: string) => {
    ...
    try {
      ...
      toAppErrorClient(_error, "Failed to update price multiplier")
    } finally {
      setLoadingId(null)
    }
  }
  ...
  const handleApprove = async (userId: string) => {
    ...
    try {
      ...
      toAppErrorClient(_error, "Failed to approve user")
    } finally {
      setLoadingId(null)
    }
  }
  ...
  const handleUnapprove = async (userId: string) => {
    ...
    try {
      ...
      toAppErrorClient(_error, "Failed to unapprove user")
    } finally {
      setLoadingId(null)
    }
  }
